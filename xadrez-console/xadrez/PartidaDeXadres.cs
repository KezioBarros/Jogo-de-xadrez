...
namespace xadrez
{
    internal class PartidaDeXadres
    {
        ...
        public void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCapiturada)
        {
            ...
            {
                tab.colacarPeca(pecaCapiturada, destino);
                capituradas.Remove(pecaCapiturada);
            }
            tab.colacarPeca(p, origem);
            ...
            // #Jogadaespecial en passent
            if(p is Peao)
            {
                if(origem.coluna != destino.coluna && pecaCapiturada == vulneravelEmPassant)
                {
        ...
        {
            tab.colacarPeca(peca, new PosicaoXadrez(coluna, linha).toPosicao());
            pecas.Add(peca);
        }
